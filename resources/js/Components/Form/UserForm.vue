            ...
            <form @submit.prevent="submitUser" class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 gap-4 mt-4">
                    ...
                    <div>
                        ...
                        <small class="text-gray-500 font-bold" v-if="props.userData">Please leave empty if you are not
                ...
                <div>
                    ...
                    <select id="currency" v-model="form.approvalRole"
                        ...
                        <option v-for="(name, code) in approvalRolesData" :key="code" :value="code" class="capitalize">
                            {{ name }}
                        </option>
                    </select>
