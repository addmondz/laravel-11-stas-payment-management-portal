...
const actionClicked = async (action) => {
    ...
    if (action == 'exportExcel') {
        ...
        const apiUrl = route('reports.transactionsReport', { dateFrom: dateFrom, dateTo: dateTo });

        await downloadExcel(apiUrl, data, 'transactions_report', dateFrom, dateTo);
        ...
        await handleReportAction(action, data, urlMap, 'transactions_report');
    }
